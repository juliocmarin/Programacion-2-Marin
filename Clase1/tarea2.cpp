...
{
 cout << "Tienen que ser mayor a cero." << endl;
...
void llenarEstudiantes(Escuela& escuela) {
 ...
 {
    cout << "No hay estudiantes creados."<<endl;
    return;
 }
...
for (int i = 0; i < escuela.cantidadEstudiantes; i++)
{
    ...
    cout << "Ingresar ID: "; cin >> escuela.estudiantes[i].id;
    ...
    cout << "Promedio: "; cin >> escuela.estudiantes[i].promedio;

    cout << "Codido de materia principal: "; cin >> escuela.estudiantes[i].codigoMateriaPrincipal;
...
for (int i = 0; i < escuela.cantidadMaterias; i++)
{
    ...
    cout <<"Ingresar Codigo: "; cin >> escuela.materias[i].codigo;
    ...
    cout << "Creditos: "; cin >> escuela.materias[i].creditos;
...
void mostrarEscuela(const Escuela& escuela) {
    ...
    {
        cout << "No hay datos para que se muestren." <<endl;
        return;
   ...
   for (int i = 0; i < escuela.cantidadMaterias; i++)
   {
    cout << setw(5) << escuela.materias[i].codigo
   ...
   for (int i = 0; i < escuela.cantidadEstudiantes; i++)
   {
    cout << setw(5) << escuela.estudiantes[i].id
         << setw(20) << escuela.estudiantes[i].nombre
         << setw(10) << fixed << setprecision(2) << escuela.estudiantes[i].promedio
         << setw(10) << escuela.estudiantes[i].codigoMateriaPrincipal << endl;
...
for (int i = 0; i < escuela.cantidadEstudiantes; i++)
{
  if(escuela.estudiantes[i].promedio >
     escuela.estudiantes[indiceMax].promedio){
